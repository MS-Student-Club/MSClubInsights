...
namespace MSClubInsights.Infrastructure.Migrations
{
    ...
    [Migration("20250404150627_addUniveristyAndCollegeTableAndRelateThemToAppUser")]
    partial class addUniveristyAndCollegeTableAndRelateThemToAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.Article", b =>
                {
                    b.HasOne("MSClubInsights.Domain.Entities.Identity.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MSClubInsights.Domain.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.ArticleTag", b =>
                {
                    b.HasOne("MSClubInsights.Domain.Entities.Article", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MSClubInsights.Domain.Entities.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("MSClubInsights.Domain.Entities.Identity.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MSClubInsights.Domain.Entities.Identity.AppUser", b =>
                {
                    b.HasOne("MSClubInsights.Domain.Entities.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MSClubInsights.Domain.Entities.College", "College")
                        .WithMany()
                        .HasForeignKey("collegeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MSClubInsights.Domain.Entities.Univeristy", "Univeristy")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MSClubInsights.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
